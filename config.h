 ...
 */
static char shell[] = "/usr/bin/env bash --login";
...
static const char *colorname[]    = { [259] = "#000000" };
static const char *altcolorname[] = { [259] = "#000000" };

static unsigned int defaultfg  = 255;
...
static Shortcut shortcuts[] = {
	...
	{ MODKEY,               XK_equal,       xzoom,          {.f = +1} },
	{ MODKEY,               XK_minus,       xzoom,          {.f = -1} },
	{ MODKEY,               XK_plus,        xzoomreset,     {.f =  0} },
